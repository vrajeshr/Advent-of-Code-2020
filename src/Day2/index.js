...
for (let currentLine of input) {
    let [bounds, rawLetter, password] = currentLine.split(" ");

    let [minimum, maximum] = bounds.split("-");

    let letter = rawLetter[0];

    let timesLetterSeen = (password.match(new RegExp(letter, "g")) || [])
        .length;
